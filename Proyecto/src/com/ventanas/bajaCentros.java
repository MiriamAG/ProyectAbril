 ...
 * @author bcastrof
 */
public class bajaCentros extends javax.swing.JFrame {

    /**
     * Creates new form bajaCentros
     */
    public bajaCentros() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        bBuscar.setPreferredSize(new java.awt.Dimension(97, 23));
        ...
        bBorrar.setPreferredSize(new java.awt.Dimension(97, 23));

        bVolver.setText("Volver");
        bVolver.setPreferredSize(new java.awt.Dimension(97, 23));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(bajaCentros.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new bajaCentros().setVisible(true);
            }
        });
    }
